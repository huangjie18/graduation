...
struct _m_usmart_nametab usmart_nametab[]=
{
	...
	(void*)xianfu_Pwm,"xianfu_Pwm(void)",
	(void*)myabs,"int myabs(int a)",
//	(void*)Test1,"float Test1(float Position_KP)",
//	(void*)Test2,"float Test2(float Position_KI)",
//	(void*)Test3,"float Test2(float Position_KD)",
//	(void*)print,"int print(void)",
